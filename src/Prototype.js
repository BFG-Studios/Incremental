...
function startFunc(){
	...
	pbImg.src = "../img/Offlight.png";
	tbImg.src = "../img/Offlight.png";
	cbImg.src = "../img/Offlight.png";
	selRender.src = "../img/Onlight.png";
	...
	farmPlot = [];
	for (i = 0; i < 4; i++){ //this stuff populates the farm/field player can grow things on
		farmPlot[i] = [];
		for (j = 0; j < 4; j++){
			var square = {};
			square.x = i*64+10;
...
eat.addEventListener("click", doEat);
potato.addEventListener("click", doPotato);
tomato.addEventListener("click", doTomato);
carrot.addEventListener("click", doCarrot);
function doSell(event)
{
